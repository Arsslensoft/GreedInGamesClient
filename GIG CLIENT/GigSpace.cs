...
namespace GIG_CLIENT
{
    ...
    internal static class GigSpace
    {
        ...
        internal static SkinCtrl SkinControl;

        internal static Home MainForm;

        internal static GigClient Client;
        internal static string ShopLink = "http://shop.greedingames.net/";
        internal static string NewsLink = "http://client.greedingames.com/News.xml";
        internal static string HOST = "http://client.greedingames.com/";
